...
# Define the variable Handcraft_Hobbies that will include c("Mech", "Garden", "Knitt", "Cook", "Gender","Age", "Marital.St", "Prof")
Handcraft_Hobbies <- dplyr::select(hobbies_, c("Mech", "Garden", "Knitt", "Cook", "Gender","Age", "Marital.St", "Prof"))

# Define the variable Charity_Hobbies that will include c("Volunteer", "Gender","Age", "Marital.St", "Prof")
...
write.csv(hobbies_, file = "hobbies_.csv", row.names = FALSE)


#save the subcategories / selected set as .CSV
write.csv(Generic_Hobbies, file = "Generic_Hobbies.csv", row.names = FALSE)
write.csv(Artistic_Hobbies, file = "Artistic_Hobbies.csv", row.names = FALSE)
write.csv(Sport_Hobbies, file = "Sport_Hobbies.csv", row.names = FALSE)
write.csv(Handcraft_Hobbies, file = "Handcraft_Hobbies.csv", row.names = FALSE)
write.csv(Charity_Hobbies, file = "Charity_Hobbies.csv", row.names = FALSE)
